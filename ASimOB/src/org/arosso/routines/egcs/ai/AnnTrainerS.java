...
public class AnnTrainerS implements NeuralNetListener {
	...
	private static String inputData = "AnnInputSVO.train";
	private static String outputFile = "AnnInputSVO.out";
	private static String outputFileANN = "AnnInputSVO.ann";

	NeuralNet nnet = new NeuralNet();

	/** Creates new AnnTrainerW */
	public AnnTrainerS() {
	}
	...
	public static void main(String args[]) {
		AnnTrainerS AnnTrainer = new AnnTrainerS();
	...
	public void Go(String inputFile, String outputFile) {
		...
		monitor.setTrainingPatterns(3516); /*
