...
public class TrafficOUTJReportGraph{
	...
	public Image getGraphic(){
        try {
			...
			db.query("SELECT ARRIVALTIME, DESTINATIONFLOOR from PASSENGER");
			...
			for(int j=0;j<tam;j++){
				...
				int destinationFloor = Integer.parseInt(((Vector)registros.get(j)).get(1).toString());
