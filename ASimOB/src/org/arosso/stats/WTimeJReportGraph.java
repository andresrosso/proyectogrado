...
public class WTimeJReportGraph {
	 ...
	 * Logger
	 */
	static Logger logger = LoggerFactory.getLogger(WTimeJReportGraph.class);
	...
	public Image getGraphic() {
		try {
			...
			db.query("SELECT (ENTRYTIME-ARRIVALTIME) from PASSENGER");
			...
			final JFreeChart chart = ChartFactory.createXYLineChart("Gráfico Tiempo de Espera", "llamadas", "tiempo de espera (seg)", data, PlotOrientation.VERTICAL, true, true, true);
			return chart.createBufferedImage(520, 400);

		} catch (Exception e) {
			logger.error("Error making WT GRAPH",e);
		}
		return null;
	}
	...
	public static void main(String[] args) {
		...
		WTimeJReportGraph gt = new WTimeJReportGraph();
		gt.getGraphic();
	}
}
